...
function Header(): JSX.Element {
  return (
    <header className="sm:flex sm:justify-between py-3 px-4 bg-slate-400 dark:dark:bg-slate-950 h-24">
      <Container>
        <div className="relative px-4 sm:px-6 lg:px-8 flex h-16 items-center justify-between w-full">
          <div className="flex items-center" id="header-logo">
            <Sheet>
              ...
              <SheetContent
                side="left"
                className="w-80 sm:w-96 bg-white dark:bg-black  dark:text-white"
              >
            ...
            <Link to="/" className="ml-4 lg:ml-0">
              <h1 className="text-xl font-bold">
                <img
                  ...
                  alt="Logo Battleships"
                  className="w-24 rounded-lg p-2"
                />
              </h1>
            </Link>
          </div>
